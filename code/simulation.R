...
fit <- jags.model("/Users/aditharun/Desktop/sim_mixmodel.jag",data=data, inits=list(b1=c(0.99,0.01)), n.chains=3)
samples <- coda.samples(fit, variable.names=c("b1","b0"), n.iter=10000, thin=10) %>%  ggs()
